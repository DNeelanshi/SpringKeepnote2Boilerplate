...
public class NoteController {
	 ...
	 */
	@PostMapping("/add")
	public  String save (ModelMap modelMap, @RequestParam(value = "noteTitle") String noteTitle, @RequestParam(value = "noteContent") String noteContent, @RequestParam(value = "noteStatus") String noteStatus){

		if(noteTitle.isEmpty() || noteContent.isEmpty() || noteStatus.isEmpty()){
			modelMap.addAttribute("error","Please fill all the fields");
			return "index";
		}else{
			Note note = new Note();
	...
	public 	String delete(@RequestParam("noteId")int id, ModelMap modalMap){

		Note note = new Note();
		noteDAO.deleteNote(id);
		modalMap.addAttribute("list",noteDAO.getAllNotes());
		return "redirect:/";
...
public String update(ModelMap modelMap, @RequestParam int noteId, @RequestParam String noteTitle, @RequestParam String noteContent, @RequestParam String noteStatus){
